        ...
        <div style={{ padding: '0 14px', width: '100%', marginBottom: 12 }}>
          <div style={{ background: 'rgba(0,6,14,.7)', border: '1px solid rgba(0,165,132,.1)', borderRadius: 4, padding: '10px 12px' }}>
            ...
            <button onClick={() => setPanel('profile')} style={{ width: '100%', fontSize: 11, color: 'rgba(0,210,165,.7)', background: 'none', border: 'none', cursor: 'pointer', fontFamily: 'inherit', marginTop: 8, textAlign: 'left', letterSpacing: '0.08em', padding: '6px 0', borderTop: '1px solid rgba(0,210,165,.12)', display: 'flex', alignItems: 'center', gap: 6 }}>
              <span style={{fontSize:13}}>Ã¢ÂÂ</span> PROFILE &amp; SETTINGS
            </button>
            <button onClick={signOut} style={{ width: '100%', fontSize: 11, color: 'rgba(255,100,100,.55)', background: 'none', border: 'none', cursor: 'pointer', fontFamily: 'inherit', marginTop: 2, textAlign: 'left', letterSpacing: '0.08em', padding: '6px 0', display: 'flex', alignItems: 'center', gap: 6 }}>
              <span style={{fontSize:13}}>Ã¢ÂÂª</span> SIGN OUT
            </button>
          </div>
        </div>
        ...
        {panel === 'profile' && (
          <div style={{ padding: '32px 28px', maxWidth: 680, margin: '0 auto' }}>
            ...
            <div style={{ background: 'rgba(0,210,165,.05)', border: '1px solid rgba(0,210,165,.15)', borderRadius: 10, padding: '24px 28px', marginBottom: 20 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 8 }}>
                ...
                <div>
                  ...
                  <div style={{ display: 'inline-block', background: isPro ? 'rgba(0,210,165,.15)' : 'rgba(0,210,165,.06)', border: `1px solid ${isPro ? 'rgba(0,210,165,.4)' : 'rgba(0,210,165,.15)'}`, borderRadius: 20, padding: '2px 12px', fontSize: 11, color: isPro ? 'rgba(0,210,165,.9)' : 'rgba(0,210,165,.45)', letterSpacing: '0.1em' }}>{isPro ? 'Ã¢ÂÂ¦ PRO' : 'FREE'}</div>
                </div>
              </div>
            </div>
            ...
            <div style={{ background: 'rgba(0,210,165,.05)', border: '1px solid rgba(0,210,165,.15)', borderRadius: 10, padding: '24px 28px', marginBottom: 20 }}>
              ...
              {isPro ? (
                <div>
                  <div style={{ color: 'rgba(0,210,165,.85)', fontSize: 15, marginBottom: 8 }}>Aellux Pro Ã¢ÂÂ $29/month</div>
                  <div style={{ color: 'rgba(0,210,165,.45)', fontSize: 13, lineHeight: 1.6 }}>Unlimited documents ÃÂ· Unlimited questions ÃÂ· Full biomarker analysis ÃÂ· All protocols</div>
                </div>
              ) : (
                <div>
                  <div style={{ color: 'rgba(0,210,165,.85)', fontSize: 15, marginBottom: 8 }}>Free Plan</div>
                  <div style={{ color: 'rgba(0,210,165,.45)', fontSize: 13, lineHeight: 1.6, marginBottom: 16 }}>3 documents ÃÂ· 5 questions/day ÃÂ· Basic dashboard</div>
                  <button onClick={upgradeToPro} style={{ background: 'rgba(0,210,165,.9)', color: '#030d14', border: 'none', borderRadius: 6, padding: '10px 24px', fontSize: 13, fontWeight: 600, cursor: 'pointer', fontFamily: 'Georgia,serif', letterSpacing: '0.04em' }}>Upgrade to Pro Ã¢ÂÂ</button>
                </div>
              )}
            </div>
