...
const css = `
  ...
  .lp-nav-btn:hover { background: #052e16; }
  ...
  .lp-hero-eyebrow {
    ...
    text-transform: uppercase; color: #052e16;
    background: rgba(5,46,22,.07); border: 1px solid rgba(5,46,22,.15);
    border-radius: 100px; padding: 6px 14px; margin-bottom: 32px;
  }
  .lp-hero-eyebrow span { width: 6px; height: 6px; border-radius: 50%; background: #052e16; animation: lp-pulse 2s ease-in-out infinite; }
  ...
  .lp-h1 em { font-style: italic; color: #052e16; }
  ...
  .lp-btn-primary:hover { background: #052e16; }
  ...
  .lp-eyebrow { font-size: 12px; font-weight: 500; letter-spacing: 0.1em; text-transform: uppercase; color: #052e16; margin-bottom: 16px; }
  ...
  .lp-quote {
    ...
    color: #052e16; line-height: 1.7;
    padding: 28px 32px; background: rgba(5,46,22,.04);
    border-left: 3px solid #052e16; border-radius: 0 8px 8px 0;
  }
  ...
  .lp-badge-normal { background: #eef6ee; color: #064e23; }
  ...
  .lp-intel-marker { display: inline-block; margin-top: 12px; font-size: 11px; font-weight: 500; color: #052e16; background: rgba(5,46,22,.07); padding: 2px 8px; border-radius: 100px; }
  ...
  .lp-price-hsa { font-size: 12px; color: #052e16; background: rgba(5,46,22,.07); border: 1px solid rgba(5,46,22,.15); display: inline-block; padding: 2px 8px; border-radius: 100px; margin-bottom: 24px; }
  ...
  .lp-price-features li::before { content: '✓'; color: #052e16; flex-shrink: 0; font-weight: 500; }
  ...
  .lp-final .lp-eyebrow { color: #064e23; }
  .lp-final-btn {
