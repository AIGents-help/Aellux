...
const SOURCES = [
  {
    ...
    tagline: 'Most complete — 100+ biomarkers in one draw',
    price: '$499/year',
    ...
    why: 'This is the single fastest path to a complete biological picture. One blood draw, 100+ markers, everything Aellux needs to give you a full synthesis.',
    turnaround: '5-7 days',
    affiliate: true,
