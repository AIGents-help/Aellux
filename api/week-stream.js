...
- ALLOWED PROTEINS ONLY: chicken breast, chicken thigh, ground beef, ground turkey, eggs, plain salmon fillet, canned tuna, canned salmon, plain shrimp, tofu, greek yogurt, cottage cheese, peanut butter. (If meal style is vegetarian/vegan, drop animal items. If animal-based, prioritize beef, eggs, organ meats, and include raw dairy.)
- MEAL STYLE GUIDANCE: If 'animal-based' — center every meal on beef/eggs/organs/raw dairy + fruit; no grains, no seed oils, minimal plant foods. If 'aip' — no grains, legumes, nightshades (tomato, pepper, eggplant, potato), eggs, dairy, nuts, seeds. If 'low-fodmap' — avoid onion, garlic, wheat, beans, most dairy, certain fruits (apples, pears, stone fruit); use garlic-infused oil instead of garlic. If 'whole30' — no sugar, alcohol, grains, legumes, dairy, soy; yes to meat, fish, eggs, vegetables, fruit, nuts. If 'high-protein' — every meal must hit 55-65g protein; carbs support training, fats are secondary. If 'diabetic' — glycemic index under 55 for all carbs, always pair carbs with protein/fat, no refined sugars or white flour.
