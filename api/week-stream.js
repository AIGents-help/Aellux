...
- Items array = SHOPPING LIST ITEMS ONLY. Format: "[ingredient] [quantity]". Examples: "ground beef 6oz", "whole eggs 3", "mixed berries 1 cup", "butter 1 tbsp", "banana 1 medium". NEVER include cooking instructions, cooking method, temperature, or serving notes in the items array. NO parentheses. NO "(cooked in butter)", NO "(warm)", NO "(optional)", NO "(for frying)". The items array feeds a grocery list — it must be what the user buys at the store, with quantities they need to buy.
