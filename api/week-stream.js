...
- ANIMAL-BASED: Proteins = beef (all cuts), lamb, pork, chicken, salmon, sardines, eggs, liver, heart, kidney, raw cheese, raw milk, butter, ghee. Carbs = FRUIT ONLY (berries, banana, mango, pineapple, melon, honey). Fats = butter, ghee, tallow, beef fat. ABSOLUTELY FORBIDDEN: white rice, brown rice, oats, bread, pasta, tortillas, beans, broccoli (high oxalate), spinach (high oxalate), seed oils, anything processed. Small amounts of low-toxin veg (zucchini, cucumber, squash) only if needed.
- CARNIVORE: Beef, lamb, pork, chicken, fish, eggs, butter, tallow only. Zero plants. Zero fruit. Salt for seasoning.
- KETO: Proteins = any meat/fish/eggs. Carbs = non-starchy vegetables only (under 10g net carbs per meal total). Fats = avocado, olive oil, butter, cheese, nuts. No grains, no fruit except berries in small amounts.
- AIP: Proteins = any meat or fish. No eggs, no dairy, no nuts, no seeds. No nightshades (NO tomato, NO pepper of any kind, NO potato, NO eggplant, NO paprika/cayenne). No grains, no legumes. YES: sweet potato, cassava, plantain, coconut, olive oil, all non-nightshade vegetables.
- LOW-FODMAP: No onion, no garlic (garlic-infused oil OK), no wheat, no rye, no beans, no lentils, no cashews, no pistachios, no apples, no pears, no stone fruit (peaches/plums/cherries), no watermelon, no regular mushrooms, no cauliflower. YES: rice, oats, potato, carrot, bell pepper (small), cucumber, tomato (limit to 1 small), strawberries, blueberries, oranges, grapes, lactose-free dairy.
...
- DIABETIC-FRIENDLY: GI under 55 for every carb. NO white rice (GI 73), NO white bread (GI 75), NO regular potato (GI 78), NO watermelon (GI 72), NO refined sugar. EVERY carb MUST be paired with protein + fat in the same meal. YES: lentils (GI 32), chickpeas (GI 28), sweet potato (GI 54), barley (GI 28), most berries (GI 25-40), all non-starchy vegetables.
- PALEO: All meat/fish/eggs, vegetables, fruit, nuts, seeds, sweet potato. No grains, no legumes, no dairy, no processed foods, no refined sugar.
- VEGETARIAN: Eggs, greek yogurt, cottage cheese, tofu, tempeh, legumes, cheese. No meat or fish.
- VEGAN: Tofu, tempeh, legumes, nuts, seeds. No animal products whatsoever.
